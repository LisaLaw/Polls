...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'polls.core.api.pagination.StandardPageNumberPagination',
    'PAGE_SIZE': 10,
    'DEFAULT_FILTER_BACKENDS': ('django_filters.rest_framework.DjangoFilterBackend',),
    'EXCEPTION_HANDLER': 'polls.core.api.exceptions.extra_exception_handler',
...
# DJANGO SNITCH
# ------------------------------------------------------------------------------
# See: https://github.com/marcosgabarda/django-snitch
INSTALLED_APPS += ("snitch",)
SNITCH_ENABLED_SEND_NOTIFICATIONS = env.bool(
    "SNITCH_ENABLED_SEND_NOTIFICATIONS", default=True
)
SNITCH_ENABLED_SEND_EMAILS = env.bool("SNITCH_ENABLED_SEND_EMAILS", default=True)
